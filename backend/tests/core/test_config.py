...
def test_discogs_token_encryption_key_can_be_configured() -> None:
    settings = Settings(
        _env_file=None,
        discogs_base_url="https://api.discogs.com",
        discogs_token_encryption_key="secret-key",
    )

    assert settings.discogs_token_encryption_key == "secret-key"
