...
description: This is your first entry point in this monorepo project. Always use this for quick references when working on the tasks and need to find a specific location of a file, app's features, or documentation.
---
...
- `docs/features/` - Documentaion for implemented features.
- `docs/implementation-plans/` - This where you write new, or update existing, plans and fetch required information when beginning a new code implementation or continuing with the next phase of already started work.
- `docs/product/` - All product related documenation lives here, e.g. Android app design system, screens spec.
